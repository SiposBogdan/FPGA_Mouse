...
HD_PWD='D:/Mouse_fpga/mouse_fpga/mouse_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelCircuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevelCircuit.tcl -notrace
